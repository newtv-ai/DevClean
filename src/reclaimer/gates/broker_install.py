...
from reclaimer.platform.windows.process import ProcessLimits, run_bounded_process
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Verify the artifact-installation subset of future Reclaimer gate G6."
    )
