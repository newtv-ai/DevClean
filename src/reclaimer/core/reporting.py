...
from reclaimer.core.models import SCHEMA_VERSION, utc_now
from reclaimer.core.state import StateStore
from reclaimer.evidence.redaction import redact_full_path, redact_secrets, redact_text
...
def iter_markdown_report(store: StateStore, scan_id: str, *, redact: bool = True) -> Iterator[str]:
    ...
    yield "\n".join(
        (
            ...
            "",
            "> This export is report-only and cannot be imported or executed by Reclaimer.",
            "",
            "## Resources",
            "",
