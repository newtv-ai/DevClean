...
from reclaimer.adapters.discovery import format_version, parse_version, resolve_executable
            ...
            return InventoryResult(
                ...
                issues=(
                    ...
                    AdapterIssue(
                        ...
                        "Reclaimer used an empty app-data Docker config directory to avoid user "
...
def _command(
    ...
    return QueryCommand(
        ...
        known_operational_writes=(
            "Reclaimer creates an empty app-data Docker config sandbox.",
        ),
    )
