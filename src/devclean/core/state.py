...
from devclean.core.models import EffectClass, Plan, Resource, ScanStatus, new_id, utc_now
from devclean.core.paths import state_path
from devclean.evidence.models import CommandEvidence, EvidenceRecord, LoopbackEvidence
...
class StateStore:
    ...
    def _migrate(self) -> None:
        ...
        if fresh:
            ...
            raise RuntimeError("state database has tables but no DevClean schema metadata")
