...
_EDGE_UPDATE_LOG_RULES: tuple[ApplicationCleanupRule, ...] = (
    ApplicationCleanupRule(
        ...
        last_use=LastUseStrategy.FILE_MTIME,
        rebuild_cost=RebuildCost.HIGH,
        label="Microsoft Edge Update diagnostic log (support evidence)",
    ),
    ApplicationCleanupRule(
        ...
        last_use=LastUseStrategy.FILE_MTIME,
        rebuild_cost=RebuildCost.HIGH,
        label="Rotated Microsoft Edge Update diagnostic log (support evidence)",
    ),
    ApplicationCleanupRule(
        ...
        last_use=LastUseStrategy.FILE_MTIME,
        rebuild_cost=RebuildCost.HIGH,
        label="Microsoft Edge installer diagnostic log (support evidence)",
    ),
)
